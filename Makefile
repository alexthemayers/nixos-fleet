...
# Read-only media-share audit on apps-1 (NFO ids, multi-movie folders,
# nested season packs, rarsets, AppleDouble). Override: HOST= MEDIA=
jellyfin-library-audit:
	./scripts/jellyfin-library-audit.sh
