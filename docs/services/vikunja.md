...
This document describes the deployment and configuration details of the **Vikunja** task manager service in the `nixos-fleet` infrastructure.

## Overview
Vikunja is an open-source task management platform. It is deployed on the primary application node, **`proxmox-gitlab`**.
