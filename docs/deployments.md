...
Targets are defined inside the `deploy.nodes` attribute in [flake.nix](file:///Users/alex/code/nixos-fleet/flake.nix).
...
The GitLab CI configuration is defined in [.gitlab-ci.yml](file:///Users/alex/code/nixos-fleet/.gitlab-ci.yml).
